...
public class DroiteAffine {
	...
	public Point2D getPointDuCercle() {
		return new Point2D("Point du cercle et droite centre", 
					Calcul.arrondirAuInf(Calcul.AbsDuPointDepuisDroiteCentreCercle(getCoef()), 8) ,
					Calcul.arrondirAuInf(Calcul.OrdDuPointDepuisDroiteCentreCercle(getCoef()), 8));
	}
